...
urlpatterns = [
    ...
    # New endpoints for lecturer and registrar features
    path('issues/unassigned/', IssueViewSet.as_view({'get': 'unassigned'}), name='unassigned-issues'),
    path('issues/report/', IssueViewSet.as_view({'get': 'report'}), name='issue-report'),
